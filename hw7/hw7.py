...
def main():
    ...
    print('Training score: ',rf.score(train_input, train_target))
    ...
    rf2.fit(train_input2, train_target2)
    predict2 = rf2.predict(test_input2)
    df_test2['predict'] = predict2
    ...
    print('Training score: ',rf2.score(train_input2, train_target2))
    print('Test score: ',rf2.score(test_input2, test_target2))
